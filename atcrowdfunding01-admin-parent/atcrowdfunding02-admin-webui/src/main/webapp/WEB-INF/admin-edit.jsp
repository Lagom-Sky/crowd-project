                ...
                <div class="panel-body">
                    <form action="admin/update.html" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="t" name="loginAcct" class="form-control" id="exampleInputPassword1" value="${requestScope.admin.loginAcct}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">用户昵称</label>
                            <input type="text" name="userName" class="form-control" id="exampleInputPassword12" value="${requestScope.admin.userName}">
                        </div>
                        <div class="form-group">
